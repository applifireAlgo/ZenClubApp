package com.zen.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* com.zen.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.zen.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.zen.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.zen.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* com.zen.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.zen.app.server.service..get*(..))")
