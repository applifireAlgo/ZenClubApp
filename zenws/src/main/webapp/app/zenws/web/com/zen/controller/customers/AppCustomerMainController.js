Ext.define('Zenws.zenws.web.com.zen.controller.customers.AppCustomerMainController', {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var treePanel = this.view.up().up().down('#AppCustomerTree');
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.appCustomerId == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
