Ext.define('Zenws.zenws.web.com.zen.controller.customers.AppCustomerCategoryMainController', {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var treePanel = this.view.up().up().down('#AppCustomerCategoryTree');
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.appcustCategoryId == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
