Ext.define('Zenws.zenws.web.com.zen.controller.location.DistrictMainController', {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var treePanel = this.view.up().up().down('#DistrictTree');
