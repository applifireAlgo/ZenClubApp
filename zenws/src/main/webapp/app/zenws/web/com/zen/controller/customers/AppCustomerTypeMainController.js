Ext.define('Zenws.zenws.web.com.zen.controller.customers.AppCustomerTypeMainController', {
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) { /** Finding record by id */
          ...
          var treePanel = this.view.up().up().down('#AppCustomerTypeTree');
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.appcustTypeId == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
