 ...
 * 
 */
Ext.define('Zenws.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Zenws.view.securityconfig.SecurityConfigController',
			'Zenws.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
