Ext.define('Zenws.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Zenws.view.usermanagement.enduser.UserProfileController', 'Zenws.view.usermanagement.admin.AddUserDetailsViewModel', 'Zenws.model.AddUserDataModel' ],
