Ext.define('Zenws.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Zenws.view.usermanagement.admin.UserPasswordReset',
	            'Zenws.view.usermanagement.admin.AddUserDetails',
	            'Zenws.view.usermanagement.admin.ViewUser'],
