Ext.define('Zenws.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Zenws.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Zenws.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Zenws.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Zenws.view.querybuildernewmodel.querydetail.QueryDetail');
