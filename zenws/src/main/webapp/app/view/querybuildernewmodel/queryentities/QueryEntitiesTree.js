Ext.define('Zenws.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Zenws.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
