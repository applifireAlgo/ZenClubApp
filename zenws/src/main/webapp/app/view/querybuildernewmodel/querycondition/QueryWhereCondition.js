Ext.define('Zenws.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Zenws.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
