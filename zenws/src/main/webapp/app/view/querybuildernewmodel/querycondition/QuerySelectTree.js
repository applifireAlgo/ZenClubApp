Ext.define('Zenws.view.querybuildernewmodel.querycondition.QuerySelectTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Zenws.view.querybuildernewmodel.querycondition.QuerySelectController',
