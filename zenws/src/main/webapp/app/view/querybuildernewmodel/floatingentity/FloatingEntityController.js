Ext.define('Zenws.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Zenws.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Zenws.view.querybuildernewmodel.queryentitiesjoins.Query',
