Ext.define('Zenws.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Zenws.view.login.LoginPageController',
	             // 'Zenws.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Zenws.view.main.MainPanel' ],
