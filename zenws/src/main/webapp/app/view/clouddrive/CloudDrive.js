Ext.define("Zenws.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Zenws.view.clouddrive.CloudDriveController',
	             'Zenws.view.clouddrive.documentview.DocumentsView',
	             'Zenws.view.clouddrive.drivedetails.DriveDetails',
	             //'Zenws.view.clouddrive.documentview.DocumentListView'
	             ],
