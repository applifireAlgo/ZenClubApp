...
Ext.define('Zenws.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Zenws.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Zenws.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
