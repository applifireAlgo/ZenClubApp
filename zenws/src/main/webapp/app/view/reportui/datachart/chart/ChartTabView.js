Ext.define('Zenws.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Zenws.view.reportui.datachart.chart.RatingField','Zenws.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
