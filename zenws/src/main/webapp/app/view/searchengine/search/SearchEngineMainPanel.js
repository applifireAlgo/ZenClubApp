Ext.define('Zenws.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Zenws.view.searchengine.search.NorthPanel', 'Zenws.view.searchengine.search.SearchResult','Zenws.view.searchengine.search.SearchEngineMainPanelController'],
