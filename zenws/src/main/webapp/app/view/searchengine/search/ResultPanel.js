Ext
		.define(
				'Zenws.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Zenws.view.searchengine.search.SearchEngineMainPanelController','Zenws.view.searchengine.search.PanelHeaderField' ,'Zenws.view.searchengine.search.ReportGridView','Zenws.view.searchengine.search.ReportChartView','Zenws.view.searchengine.search.documentView','Zenws.view.searchengine.search.DouMeanView','Zenws.view.googlemaps.map.MapPanel'],
