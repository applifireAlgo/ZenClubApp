 ...
 * 
 */
Ext.define('Zenws.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Zenws.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Zenws.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
