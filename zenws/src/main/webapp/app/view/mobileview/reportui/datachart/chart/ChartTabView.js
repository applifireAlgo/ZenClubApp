Ext.define('Zenws.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Zenws.view.mobileview.reportui.datachart.chart.RatingField','Zenws.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
