Ext.define('Zenws.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Zenws.view.resource.ResourcePanel',
			'Zenws.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Zenws.view.resource.DockedResourcePanel','Zenws.view.fw.mainViewPanel.MainPanelController' ],
