Ext.define('Zenws.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Zenws.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Zenws.view.reportbuilder.gridconfig.GridConfigView',
	           'Zenws.view.reportbuilder.properties.PropertiesPanelView',
	           'Zenws.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
