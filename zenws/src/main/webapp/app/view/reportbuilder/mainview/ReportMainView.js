Ext.define('Zenws.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Zenws.view.reportbuilder.reportlist.ReportListPanelView',
             'Zenws.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Zenws.view.reportbuilder.mainview.ReportMainController'
             ],
