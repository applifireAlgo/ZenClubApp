...
Ext
		.define(
				'Zenws.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Zenws.view.logger.tabs.details.DetailsTab',
							'Zenws.view.logger.tabs.fileconnector.FileConnectorTab',
							'Zenws.view.logger.tabs.dbconnector.DBConnectorTab',
							'Zenws.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Zenws.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Zenws.view.logger.LogConfigurationTabPanelController',
