 ...
 * 
 */
Ext.define('Zenws.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Zenws.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
