 ...
 * 
 */
Ext.define('Zenws.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Zenws.view.logalarm.mainscreen.AddLogAlarmController',
			'Zenws.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Zenws.view.logalarm.mainscreen.AppAlarmPanel',
