 ...
 * 
 */
Ext.define('Zenws.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Zenws.view.logalarm.LogAlarmMainViewController',
			'Zenws.view.logalarm.tree.LogAlarmTreePanel',
			'Zenws.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
